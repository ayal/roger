...
/***/ function(module, exports, __webpack_require__) {
	...
	function MasonryComponent(React) {
		...
		showSquares: function(inst) {
		    ...
		    console.log('showing', inst.images, loaded);
	//	    console.log(loaded);
	...
	/*	    setTimeout(function(){
	        ...
	        render: function() {
		    var that = this;
		    var all = _.map(this.props.children, function(x){
			return React.createElement('img', {src: x.props.src});
		    });
		    
		    var oksquares = _.filter(this.props.children, function(x){
	//		console.log(x.props.src, that.state.loaded[x.props.src], that.state.loaded)
			return false;
		    });
			...
			React.createElement(
					"div",
					{ ref: refName, className: this.props.className },
					oksquares
			)
	);
