	...
	var Square = _react2.default.createClass({
					...
					render: function render() {
									return _react2.default.createElement(
													'div',
													{ className: 'square' },
													_react2.default.createElement('a', { className: 'tweet', href: "https://twitter.com/intent/tweet?text=" + this.props.name + "&via=nuschooler&url=" + encodeURIComponent(this.props.href) + "&original_referer=" }),
													_react2.default.createElement(
																	'a',
