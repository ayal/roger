	...
	var Square = _react2.default.createClass({
					...
					render: function render() {
									return _react2.default.createElement(
													'div',
													{ className: 'square' },
													_react2.default.createElement('a', { target: '_blank', className: 'tweet', href: "https://twitter.com/intent/tweet?text=" + encodeURIComponent(this.props.name) + "&hashtags=frameroger&via=nuschooler&url=" + encodeURIComponent(this.props.href) + "&original_referer=" }),
													_react2.default.createElement(
																	'a',
