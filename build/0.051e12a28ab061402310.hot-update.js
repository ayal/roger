...
/***/ function(module, exports, __webpack_require__) {
	...
	var Trianglify = __webpack_require__(217);

	var Masonry = __webpack_require__(256)(_react2.default);
	...
	var list = ["http://nofilmschool.com/rss.xml", "https://www.cinema5d.com/feed/", "http://petapixel.com/topic/inspiration/feed/", "http://philipbloom.net/blog/feed/", "http://filmmakeriq.com/feed/", "http://www.comingsoon.net/feed", "https://vimeo.com/theawardeocompany/videos/rss", "https://vimeo.com/channels/staffpicks/videos/rss", "http://www.premiumbeat.com/blog/feed/", "http://cinearchive.org/rss", "https://www.youtube.com/feeds/videos.xml?channel_id=UCSpFnDQr88xCZ80N-X7t0nQ", "https://www.youtube.com/feeds/videos.xml?channel_id=UCYaIdC5pbkpECxXLjf0Lzaw", "https://gointothestory.blcklst.com/category/infographic/feed", "https://www.hurlbutvisuals.com/blog/feed/"];
									...
									return _react2.default.createElement(
													...
													_react2.default.createElement(
																	...
																	_react2.default.createElement(
																					...
																					_react2.default.createElement(
																									'div',
																									{ className: 'w-widget w-widget-facebook mrk-share' },
																									_react2.default.createElement('iframe', { src: "https://www.facebook.com/plugins/like.php?href=" + shareurl + "&amp;layout=button_count&amp;locale=en_US&amp;action=like&amp;show_faces=false&amp;share=true", scrolling: 'no', frameborder: '0', allowtransparency: 'true' })
																					),
																					_react2.default.createElement(
																									'div',
																									{ className: 'w-widget w-widget-twitter mrk-share mrk-twitt' },
																									_react2.default.createElement('iframe', { src: "https://platform.twitter.com/widgets/tweet_button.html#url=" + shareurl + "&amp;counturl=webflow.com&amp;text=Marketing for Honest Freelancers&amp;count=none&amp;size=m&amp;dnt=true", scrolling: 'no', frameborder: '0', allowtransparency: 'true' })
																					),
																					_react2.default.createElement(
																									'div',
																									{ className: 'w-widget w-widget-gplus mrk-share' },
																									_react2.default.createElement('div', { className: 'g-plusone', 'data-href': shareurl, 'data-size': 'medium', 'data-annotation': 'bubble', 'data-width': '120', 'data-recommendations': 'false', id: '___plusone_0', style: 'width: 70px!important; height: 20px; text-indent: 0px; margin: 0px; padding: 0px; border-style: none; float: none; line-height: normal; font-size: 1px; vertical-align: baseline; display: inline-block; background: transparent;' })
																					)
																	)
													),
													_react2.default.createElement(
	...
	var Square = _react2.default.createClass({
					...
					clicktweet: function clicktweet(u) {
									return function (e) {
													e.preventDefault();
					...
					render: function render() {
									return _react2.default.createElement(
													'div',
													{ className: 'square' },
													_react2.default.createElement('a', { target: '_blank', className: 'tweet', href: '#', onClick: this.clicktweet("https://twitter.com/intent/tweet?text=" + encodeURIComponent(this.props.name) + "&hashtags=frameroger&via=nuschooler&url=" + encodeURIComponent(this.props.href) + "&original_referer=") }),
													_react2.default.createElement(
																	'a',
